...
public class KeepLongAdapter extends RecyclerView.Adapter<KeepLongAdapter.ViewHolder> {
    private final File[] audioFiles;
    private ViewHolder prevControl = null;


    public KeepLongAdapter(KeepLong recordData) {
    ...
    @NonNull
    @Override
    public KeepLongAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.game_history_view, parent, false);
        return new KeepLongAdapter.ViewHolder(view);
    }
