...
public interface DataUao {
    ...
    /**複雜(?)新增所有資料的方法*/
    @Query("INSERT INTO "+tableName+"(name,phone,mail,BD) VALUES(:name,:phone,:mail,:BD)")
    void insertData(String name,String phone,String mail,String BD);
    ...
    /**複雜(?)更新資料的方法*/
    @Query("UPDATE "+tableName+" SET name = :name,phone=:phone,mail= :mail,BD =:BD WHERE id = :id" )
    void updateData(int id,String name,String phone,String mail,String BD);
